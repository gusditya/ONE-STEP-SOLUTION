...
export default function Layanankami() {
    return (
        <div className="Layanankami flex flex-col gap-3">
            <div className="title-layanankami flex flex-col gap-1">
                <h2 className="text-layanankami font-extrabold text-3xl">Layanan Kami</h2>
            ...
            <div className="Card-layanankami">
                <div className="Card1-layanankami">
                    <div className="IconBox"><GraduationCap size={32} /></div>
                ...
                <div className="Card1-layanankami">
                    <div className="IconBox"><WalletCards size={32} /></div>
                    <div className="Box-text">
                ...
                <div className="Card1-layanankami">
                    <div className="IconBox"><MessageCircleMore size={32} /></div>
                    <div className="Box-text">
                ...
                <div className="Card1-layanankami">
                    <div className="IconBox"><FileText size={32} /></div>
                    <div className="Box-text">
                ...
                <div className="Card1-layanankami">
                    <div className="IconBox"><HousePlus size={32} /></div>
                    <div className="Box-text">
